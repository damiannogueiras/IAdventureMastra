...
const sala_actual = JSON.stringify(GameState.gameState.sala_actual)
...
export const describeAgent = new Agent({
  ...
  instructions: `
      ...
      Utilizas ${sala_actual} para poder hacer la descripciones que te pida el usuario.
      ...
      Contestas con solamente 75 tokens
  `,
